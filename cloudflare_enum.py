#!/usr/bin/env python
# -*- coding: utf-8 -*-
# Created using  by OzgurD 
# Unauthorized use is stricly prohibited, please contact lucello@gmx.de with questions/comments.
import requests
import json
import csv
import sys
...
class cloudflare_enum:
    ...
    def log_in( self, username, password ):
        ...
        parse_dict[ 'security_token_0' ] = self.find_between_r( r.text, '"security_token":"', '"}};</script>' ) 
    ...
    def get_domain_dns( self, domain ):
        ...
        post_data = {
            "betas": [],
            "created_on": "2016-05-24T00:27:16.048Z",
